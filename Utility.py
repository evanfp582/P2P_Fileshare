...
def split_file(folder, filename, piece_size):
  ...
  """
    ...
    with open(local_files, "rb") as file:
        while piece := file.read(piece_size):
            # If < packet size, fill in with buffer '\0'
            pieces.append(piece.ljust(piece_size, b'\0'))
    return pieces
